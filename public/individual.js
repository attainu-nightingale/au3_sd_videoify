   ...
   success: function (data) {
      for (i = 0; i < data.items.length; i++) {
         $('#div3').append("<div class='card mb-2 p-2 '>" +
            "<a class='text-decoration-none' href='/individual/video/" + data.items[i].id.videoId + "'" + "><img style='height:230px' src=" + data.items[i].snippet.thumbnails.high.url + " class='card-img img-thumbnail'>" +
